...
<<<<<<< HEAD
    try {
        // Simple parameter replacement for safety
...
>>>>>>> ccf6216356e229a72fe8d3fca6c6c880996271ba
        ...
        if (data.error) {
<<<<<<< HEAD
            console.error('Spider SQL Error:', data.error);
=======
...
<<<<<<< HEAD
        console.error('Spider query failed:', err.message);
=======
...
async function uploadFile(fileBuffer, filename, mimetype) {
    ...
    return {
        id: file.id,
<<<<<<< HEAD
        url: `${API_URL}/storage/files/${file.id}`,
...
<<<<<<< HEAD
    return `${API_URL}/storage/files/${fileId}?X-API-KEY=${API_KEY}`;
=======
